...
const expected = new Map([
  ...
  ['apps/web/src/app/api/ops/billing/defer-and-close/route.ts', ['requireOpsActorContext', 'requireBillingAccess']],
  ...
  ['apps/web/src/app/api/ops/billing/receipt/route.ts', ['requireOpsActorContext', 'requireBillingAccess']],
  ['apps/web/src/app/api/ops/billing/settle-and-close/route.ts', ['requireOpsActorContext', 'requireBillingAccess']],
  ['apps/web/src/app/api/ops/menu/addons/create/route.ts', ['requireOpsActorContext', 'requireOwnerRole']],
  ['apps/web/src/app/api/ops/menu/addons/delete/route.ts', ['requireOpsActorContext', 'requireOwnerRole']],
  ['apps/web/src/app/api/ops/menu/addons/toggle/route.ts', ['requireOpsActorContext', 'requireOwnerRole']],
  ['apps/web/src/app/api/ops/menu/addons/update/route.ts', ['requireOpsActorContext', 'requireOwnerRole']],
  ['apps/web/src/app/api/ops/orders/open-and-create/route.ts', ['requireOpsActorContext', 'requireSessionOrderAccess', 'requireOpenOpsShift']],
  ['apps/web/src/app/api/ops/workspaces/waiter-catalog/route.ts', ['requireOpsActorContext', 'requireWaiterWorkspaceAccess']],
  ['apps/web/src/app/api/ops/workspaces/waiter-live/route.ts', ['requireOpsActorContext', 'requireWaiterWorkspaceAccess']],
