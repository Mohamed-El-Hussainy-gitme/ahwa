    ...
    <MobileShell title="QR الطلب" backHref="/owner" desktopMode="admin">
      <section className="space-y-5">
        <div className="rounded-[28px] border border-[#dccdbb] bg-[linear-gradient(180deg,#fff9f2_0%,#f6ecdf_100%)] p-5 shadow-[0_18px_40px_rgba(30,23,18,0.08)]">
          ...
          <h1 className="mt-2 text-[26px] font-black leading-tight text-[#1e1712] xl:text-[32px]">بطاقة QR للطلب الذاتي</h1>
          <p className="mt-2 max-w-4xl text-sm leading-7 text-[#6b5a4c] xl:text-[15px]">
