        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2 2xl:grid-cols-3">
          {cards.map((card) => (
            <Link
              key={card.href}
              href={card.href}
              className="group rounded-[24px] border border-[#dccdbb] bg-[#fffaf4] px-4 py-4 text-right shadow-sm transition duration-150 hover:-translate-y-0.5 hover:bg-[#f8efe3] lg:px-5 lg:py-5"
            >
              ...
              <div className="mt-2 text-xs leading-6 text-[#6b5a4c] md:text-sm">{card.description}</div>
            </Link>
          ))}
        </div>
      </section>
