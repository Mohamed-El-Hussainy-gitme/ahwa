      ...
      <div className="w-full max-w-sm overflow-hidden rounded-[32px] border border-[#d9cabb] bg-[#fffaf4] shadow-[0_28px_72px_rgba(30,23,18,0.12)]">
        ...
        >
          <div className="space-y-3">
            ...
            <button
              type="button"
              onClick={() => router.push(resolvedSlug ? `/owner-password?slug=${encodeURIComponent(resolvedSlug)}` : '/owner-password')}
              className="inline-flex w-full items-center justify-center gap-2 rounded-[20px] border border-[#d9cabb] bg-[#f7efe4] px-4 py-3.5 text-sm font-medium text-[#6b5a4c] transition hover:bg-[#f3e7d7]"
            >
